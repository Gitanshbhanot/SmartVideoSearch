  ...
  return (
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-base z-50 border-none bg-transparent text-black h-full rounded-full focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-20",
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="text-xs sm:text-base font-normal text-neutral-500 pl-4 sm:pl-12 text-left w-[calc(100%-2rem)] truncate"
            >
